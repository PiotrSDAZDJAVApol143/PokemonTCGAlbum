...
export default function Pokedextest() {
                ...
                <div className="grid grid-cols-5 gap-4">
                    {pokemonList.map((pokemon) => (
                        <div
                            ...
                            className={`border-4 rounded-lg p-2 cursor-pointer flex flex-col items-center ${selected && selected.pokedexNumber === pokemon.pokedexNumber ? "border-purple-700" : "border-gray-400"}`}
