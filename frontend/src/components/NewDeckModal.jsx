...
export default function NewDeckModal({ logos, onSave, onClose }) {
    const [name, setName] = useState("");
    const [logoUrl, setLogoUrl] = useState(logos[0]);
    const [baseEnergy, setBaseEnergy] = useState("");
    const [secondaryEnergy, setSecondaryEnergy] = useState("");
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 flex justify-center items-center z-50">
            <div className="bg-white p-8 rounded-xl min-w-[350px] shadow-xl relative">
                ...
                <div className="text-lg font-bold mb-2">Stwórz Nową Talię</div>
                ...
                <div className="flex gap-4 mt-6 justify-end">
                    <button
                        ...
                        onClick={() => {
                            console.log("Kliknięto Stwórz!");
                            console.log("typeof onSave", typeof onSave, onSave);
                            onSave({name, logoUrl, baseEnergy, secondaryEnergy: secondaryEnergy || null});
                        }}
                    >Stwórz
                    </button>
                    <button
